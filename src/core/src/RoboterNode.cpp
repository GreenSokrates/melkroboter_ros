...
void RoboterNode::initializeSubscribers()
{
  ...
  sub_teat_vl = nh_.subscribe(thisString, 1, &RoboterNode::RoboterNode::teat_vl_cb_, this);
  sub_teat_vr = nh_.subscribe("/melkroboter/teats/vr", 1, &RoboterNode::RoboterNode::teat_vr_cb_, this);
  sub_teat_hl = nh_.subscribe("/melkroboter/teats/hl", 1, &RoboterNode::RoboterNode::teat_hl_cb_, this);
  sub_teat_hr = nh_.subscribe("/melkroboter/teats/hr", 1, &RoboterNode::RoboterNode::teat_hr_cb_, this);
  sub_teat_count = nh_.subscribe("/melkroboter/teats/counter", 1, &RoboterNode::RoboterNode::teat_count_cb_, this);
}
...
bool RoboterNode::start_cb_(core::startMelk::Request &req, core::startMelk::Response &res)
{
  ...
  while (maxTeatCount != 4)
  {
    ...
    if (timer % 4 == 0)  // after 2 secs
    {
      ...
      geometry_msgs::Pose pose = (group->getCurrentPose(group->getEndEffectorLink())).pose;
  ...
  /*
    for (size_t i = 0; i < 5; i++)
    {
      ...
      ROS_INFO("Attatching Teatcup %lu", i);
